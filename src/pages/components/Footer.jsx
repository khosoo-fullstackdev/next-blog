      ...
      <div className="w-[1215px] justify-start items-start gap-5 inline-flex">
        <div className="w-[289px] flex-col justify-start items-start gap-6 inline-flex">
          ...
          <div className="flex-col justify-start items-start gap-1 flex">
            <div>
              <span className="text-gray-900 text-base font-normal font-['Work Sans'] leading-normal">
                Email :{" "}
              </span>
              <span className="text-zinc-700 text-base font-normal font-['Work Sans'] leading-normal">
                info@jstemplate.net
              </span>
            </div>
            <div>
        ...
        <div className="h-[88px] justify-center items-start gap-20 flex">
          <div className="flex-col justify-start items-start gap-6 inline-flex">
            <div className="flex-col justify-start items-start gap-2 flex">
              <button className="text-zinc-700 text-base font-normal font-['Work Sans'] leading-normal">
                Home
              </button>
              <button className="text-zinc-700 text-base font-normal font-['Work Sans'] leading-normal">
                Blog
        ...
        <div className="w-36 relative">
          <div className="w-4 h-4 left-0 top-0 absolute flex-col justify-start items-start inline-flex"></div>
          <div className="w-4 h-4 left-[42.67px] top-0 absolute flex-col justify-start items-start inline-flex"></div>
      ...
      <div className="w-[1216px] h-[95px] py-8 border-t border-zinc-200 justify-start items-center gap-16 inline-flex">
        <div className="justify-start items-center gap-2.5 flex">
          <div className="flex-col justify-start items-start gap-0.5 inline-flex">
            <div>
              <span className="text-gray-900 text-xl font-normal font-['Plus Jakarta Sans'] leading-7">
                Meta
              </span>
              <span className="text-gray-900 text-xl font-extrabold font-['Plus Jakarta Sans'] leading-7">
                Blog
              </span>
            </div>
